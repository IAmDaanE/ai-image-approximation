...
This was written in python using my very own [barebones_ml](https://github.com/IAmDaanE/bare-bones-ml) machine learning library and pygame for the visualization. The input to the neural network is the coordinate of the pixel on the image, the output is its approximation of the greyscale value of that pixel.
