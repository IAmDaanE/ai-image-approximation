...
This was written in python using [my very own neural network library](https://github.com/IAmDaanE/bare-bones-ml). The input to the neural network is the coordinate of the pixel on the image, the output is its approximation of the greyscale value of that pixel.
